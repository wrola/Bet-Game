    ...
    render() {
        ...
        return (
            <div className="main-form-slider" style={{display: 'flex', justifyContent: 'space-around'}}>
                <button type="button" onClick={this.prevSlide} className="main-form-prev" style={{background: 'transparent', border:'0', color: '#00134d',background: 'transparent',transition: '0.5s color',cursor:'pointer'}}>
                    &lt;
                </button>
                <label>Team</label>
